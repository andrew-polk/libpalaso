...
namespace SIL.DblBundle.Text
{
	...
	public class Book
	{
		...
		/// (while allowing it to be deserialized)
		/// </summary>
		public bool ShouldSerializeCode_DeprecatedXml() { return false; }
		...
		/// </summary>
		[XmlAttribute("code")]
		public string Code_DeprecatedXml
		{
			get { return Id; }
			set { Id = value; }
		}
		...
		/// <summary>
		/// This is required to prevent a breaking change to the API after deprecating the code attribute above.
		/// </summary>
		[XmlIgnore]
		public string Code
		{
		...
		public string Id
		{
			get
			{
				if (_id == null)
					return null;
				if (!_id.StartsWith(DblTextMetadata<DblMetadataLanguage>.Version2BookIdPrefix))
					return DblTextMetadata<DblMetadataLanguage>.Version2BookIdPrefix + _id.ToLower();
				return _id;
			}
			set { _id = value; }
		}
